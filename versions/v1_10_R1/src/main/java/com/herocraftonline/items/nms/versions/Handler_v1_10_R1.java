...
public class Handler_v1_10_R1 extends NMSHandler {
    ...
    private net.minecraft.server.v1_10_R1.ItemStack getNmsItem(ItemStack item) {
        if (item instanceof CraftItemStack) {
            ...
            try {
                return (net.minecraft.server.v1_10_R1.ItemStack) HANDLE_FIELD.get(itemStack);
    ...
    public ItemStack fromTagCompound(com.herocraftonline.items.api.storage.nbt.NBTTagCompound compound) {
        return CraftItemStack.asBukkitCopy(net.minecraft.server.v1_10_R1.ItemStack.createStack((NBTTagCompound) compound));
    }
