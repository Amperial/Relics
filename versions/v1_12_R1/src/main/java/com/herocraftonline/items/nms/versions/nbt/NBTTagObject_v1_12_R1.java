...
public class NBTTagObject_v1_12_R1<T> extends NBTTagByte_v1_12_R1 implements NBTTagObject<T> {

    private T object;

    public NBTTagObject_v1_12_R1(T object) {
        super((byte) 0);
    ...
    public <B> NBTTagObject<B> newInstance(B item) {
        return new NBTTagObject_v1_12_R1<>(item);
    }
    ...
    @Override
    public NBTTagObject_v1_12_R1<T> c() {
        return new NBTTagObject_v1_12_R1<>(object);
    }
